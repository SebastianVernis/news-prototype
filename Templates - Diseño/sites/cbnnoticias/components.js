/**
 * CBN Noticias - Componentes Compartidos
...
<div id="site-preloader" class="cbn-preloader">
    <div class="cbn-ring-wrapper">
        <svg class="cbn-progress-ring" width="200" height="200" viewBox="0 0 200 200">
            <circle class="cbn-ring-bg" cx="100" cy="100" r="90"></circle>
            <circle class="cbn-ring-circle" cx="100" cy="100" r="90" id="cbn-progress-circle"></circle>
        </svg>
        <div class="cbn-progress-text" id="cbn-progress-text">0%</div>
    </div>
    <div class="cbn-preloader-logo">
        <img src="${base}logo-header.png" alt="CBN Noticias">
    </div>
</div>
<style>
.cbn-preloader {
    ...
    background: linear-gradient(135deg, #021A4A 0%, #0451C4 50%, #086EC1 100%);
    display: flex;
    align-items: center;
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo-header.png" alt="CBN Noticias" class="site-logo">
            </a>
        </div>
        <nav class="main-nav">
...
<section class="breaking-news">
    ...
    <div class="breaking-ticker">
        <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
            <span class="ticker-item">Bienvenido a CBN Noticias &mdash; Información verificada las 24 horas</span>
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                <div class="footer-logo">
                    <img src="${base}logo_landscape.png" alt="CBN Noticias">
                    <h3>CBN Noticias</h3>
                </div>
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">Noticias con credibilidad. Información veraz y oportuna.</p>
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; 2026 CBN Noticias. Todos los derechos reservados.</p>
    ...
    function initImageFallbacks() {
        var logoSrc = base + 'logoconfondo.png';
    ...
    function initPreloader() {
        const circle = document.getElementById('cbn-progress-circle');
        const text   = document.getElementById('cbn-progress-text');
        const pre    = document.getElementById('site-preloader');
        if (!circle || !text || !pre) return;
        ...
        const timer = setInterval(() => {
            ...
            if (progress >= 100) {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => { if (pre.parentNode) pre.parentNode.removeChild(pre); }, 500);
                }, 300);
            }
