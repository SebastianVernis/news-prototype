...
class UnifiedImageGenerator:
    ...
    def __init__(self, output_dir=None, prefer_ai: bool = False, use_cache: bool = True):
        """
        ...
        self.newsapi_generator = NewsAPIImageGenerator(self.output_dir, use_cache=use_cache)
        
        # Intentar inicializar IA si se prefiere
        if prefer_ai:
            try:
                self.ai_generator = AIImageGenerator(self.output_dir)
        ...
        self.unsplash_generator = UnsplashImageGenerator(self.output_dir)
