...
def update_api_functions_with_r2_images():
    ...
    api_file_path = "/home/sebastianvernis/cloudflare-news-project/functions/api/articles/index.js"
...
def update_individual_article_function(r2_image_mapping):
    ...
    article_file_path = "/home/sebastianvernis/cloudflare-news-project/functions/api/articles/[slug].js"
  ...
  upload-and-update:
    ...
    steps:
      ...
      - name: Upload image to R2
        run: |
          python core/scripts/upload_to_r2.py "${{ inputs.image_path }}" "${{ inputs.article_slug }}"
      
      - name: Update API with new image URL
        run: |
          python core/scripts/update_api_image.py "${{ inputs.article_slug }}" "${{ secrets.API_UPDATE_TOKEN }}"
'''
    
    workflow_path = "/home/sebastianvernis/news-prototype/.github/workflows/upload-images.yml"
