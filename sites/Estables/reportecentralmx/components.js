/**
 * Reporte Central MX - Componentes Compartidos
...
<div id="site-preloader" class="rcm-preloader">
    <img src="${base}logo-header.png" alt="Reporte Central MX" class="rcm-preloader-logo">
    <div class="rcm-bars">
        <div class="rcm-bar"></div>
        <div class="rcm-bar"></div>
        <div class="rcm-bar"></div>
        <div class="rcm-bar"></div>
        <div class="rcm-bar"></div>
    </div>
    <p class="rcm-preloader-text">Reporte Central MX</p>
</div>
<style>
.rcm-preloader {
    position: fixed;
...
.rcm-preloader.loaded { opacity: 0; pointer-events: none; }
.rcm-preloader-logo {
    height: 65px;
    width: auto;
    object-fit: contain;
...
.rcm-bar {
    width: 8px;
    height: 18px;
    background: var(--rcm-rose, #9B3D3F);
    border-radius: 3px;
    animation: rcm-bounce 1s ease-in-out infinite;
}
.rcm-bar:nth-child(1) { animation-delay: 0s;    background: #202020; }
.rcm-bar:nth-child(2) { animation-delay: 0.1s;  background: #2E2E2E; }
.rcm-bar:nth-child(3) { animation-delay: 0.2s;  background: #9B3D3F; }
.rcm-bar:nth-child(4) { animation-delay: 0.3s;  background: #2E2E2E; }
.rcm-bar:nth-child(5) { animation-delay: 0.4s;  background: #202020; }
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo-header.png" alt="Reporte Central MX" class="site-logo">
            </a>
        </div>
        <nav class="main-nav">
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                <div class="footer-logo">
                    <img src="${base}logo-header.png" alt="Reporte Central MX" style="height:48px;width:auto;object-fit:contain;display:block;">
                    <h3>Reporte Central MX</h3>
                </div>
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">Periodismo de investigación. Análisis profundo de la realidad mexicana.</p>
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; 2026 Reporte Central MX. Todos los derechos reservados.</p>
    ...
    function initFixedHeader() {
        ...
        s.textContent =
            '.header-container{display:flex!important;align-items:center!important;justify-content:space-between!important;}' +
            '.main-nav{display:flex!important;align-items:center;gap:4px;flex-wrap:wrap;}' +
