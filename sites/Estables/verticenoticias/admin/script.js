/* ========================================
   Vértice Noticias - Admin CMS Script
   ======================================== */

const API_BASE = window.location.hostname === 'localhost' ? 'http://localhost:8781/api' : '/api';
const STORAGE_KEY = 'cms_articles_verticenoticias';
const TOKEN_KEY = 'cms_token_verticenoticias';
const SESSION_KEY = 'cms_session_verticenoticias';
