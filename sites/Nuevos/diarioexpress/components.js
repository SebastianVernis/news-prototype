...
<div id="unified-ticker-container" style="position:fixed;top:0;left:0;right:0;height:40px;background:#000;color:#fff;z-index:10001;display:flex;align-items:center;font-family:'Inter',sans-serif;border-bottom:1px solid ${siteConfig.accentColor};">
    <div style="background:${siteConfig.accentColor};color:#fff;height:100%;display:flex;align-items:center;padding:0 15px;font-weight:800;font-size:0.75rem;text-transform:uppercase;letter-spacing:1px;flex-shrink:0;">
        AL MOMENTO
    </div>
...
<header class="header" style="margin-top:40px;background:#fff;border-bottom:2px solid ${siteConfig.accentColor};position:sticky;top:40px;z-index:10000;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;padding:15px 20px;max-width:1400px;margin:0 auto;position:relative;">
        ...
        <!-- Mobile Toggle -->
        <button id="mobile-toggle" style="display:none;background:none;border:none;color:#1a1a1a;font-size:1.5rem;cursor:pointer;z-index:1001;">
            <i class="fas fa-bars"></i>
        </button>

        <nav class="main-nav">
            <ul style="display:flex;gap:30px;list-style:none;margin:0;padding:0;">
                <li><a href="${base}" class="nav-link${cls(isHome)}" style="text-decoration:none;color:#1a1a1a;font-weight:700;font-size:0.85rem;text-transform:uppercase;letter-spacing:1px;">Inicio</a></li>
                <li><a href="${base}categoria/nacional.html" class="nav-link${cls(isNacional)}" style="text-decoration:none;color:#1a1a1a;font-weight:700;font-size:0.85rem;text-transform:uppercase;letter-spacing:1px;">Nacional</a></li>
                <li><a href="${base}categoria/politica.html" class="nav-link${cls(isPolitica)}" style="text-decoration:none;color:#1a1a1a;font-weight:700;font-size:0.85rem;text-transform:uppercase;letter-spacing:1px;">Política</a></li>
                <li><a href="${base}categoria/economia.html" class="nav-link${cls(isEconomia)}" style="text-decoration:none;color:#1a1a1a;font-weight:700;font-size:0.85rem;text-transform:uppercase;letter-spacing:1px;">Economía</a></li>
                <li><a href="${base}categoria/deportes.html" class="nav-link${cls(isDeportes)}" style="text-decoration:none;color:#1a1a1a;font-weight:700;font-size:0.85rem;text-transform:uppercase;letter-spacing:1px;">Deportes</a></li>
            </ul>
        </nav>
    </div>
</header>
<style>
    @media (max-width: 900px) {
        ...
        .main-nav ul li a { font-size: 1.1rem !important; }
    }
</style>`;

    // ── FOOTER ───────────────────────────────────────────────────────────────
    const FOOTER_HTML = `
<footer class="footer" style="background:#1a1a1a;color:#fff;padding:60px 0 40px;margin-top:60px;">
    <div class="container" style="max-width:1400px;margin:0 auto;padding:0 20px;display:grid;grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));gap:50px;">
        <div class="footer-column">
            <img src="${base}logo-header.png" alt="${siteConfig.name}" style="height:40px;filter:brightness(0) invert(1);margin-bottom:25px;">
            <p style="color:#888;font-size:0.95rem;line-height:1.6;font-family:'Helvetica Neue',sans-serif;">Información veraz y directa. El pulso de la noticia en tiempo real con un diseño pensado para la lectura.</p>
        </div>
        <div class="footer-column">
            <h4 style="color:${siteConfig.accentColor};text-transform:uppercase;margin-bottom:25px;font-size:0.9rem;letter-spacing:2px;font-weight:800;">Secciones</h4>
            <ul style="list-style:none;padding:0;margin:0;display:grid;grid-template-columns: 1fr 1fr;gap:15px;">
                <li><a href="${base}categoria/nacional.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Nacional</a></li>
                <li><a href="${base}categoria/politica.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Política</a></li>
                <li><a href="${base}categoria/economia.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Economía</a></li>
                <li><a href="${base}categoria/deportes.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Deportes</a></li>
                <li><a href="${base}categoria/cultura.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Cultura</a></li>
                <li><a href="${base}categoria/tecnologia.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Tecnología</a></li>
            </ul>
        </div>
        <div class="footer-column">
            <h4 style="color:${siteConfig.accentColor};text-transform:uppercase;margin-bottom:25px;font-size:0.9rem;letter-spacing:2px;font-weight:800;">Legal</h4>
            <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:15px;">
                <li><a href="${base}acerca-de.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Acerca de</a></li>
                <li><a href="${base}contacto.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Contacto</a></li>
                <li><a href="${base}privacidad.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Privacidad</a></li>
                <li><a href="${base}terminos.html" style="color:#ccc;text-decoration:none;font-size:0.9rem;font-weight:500;">Términos</a></li>
            </ul>
        </div>
    </div>
    <div style="max-width:1400px;margin:60px auto 0;padding:30px 20px 0;border-top:1px solid rgba(255,255,255,0.05);text-align:center;color:#555;font-size:0.8rem;font-family:'Helvetica Neue',sans-serif;text-transform:uppercase;letter-spacing:2px;">
