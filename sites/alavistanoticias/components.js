(function () {
    const HEADER_HTML = '<header class="site-header">' +
        '<div class="header-container">' +
            '<div class="logo-section">' +
                '<a href="/"><img src="https://placehold.co/400x100/008080/ffffff?text=A La Vista" alt="A La Vista"></a>' +
            '</div>' +
            '<nav class="main-nav">' +
                '<a href="/">Inicio</a>' +
    ...
    const FOOTER_HTML = '<footer class="site-footer">' +
        '<div class="footer-logo">' +
            '<img src="https://placehold.co/400x100/008080/ffffff?text=A La Vista" alt="A La Vista">' +
        '</div>' +
        ...
        '</div>' +
        '<p>&copy; ' + new Date().getFullYear() + ' A La Vista. Todos los derechos reservados.</p>' +
    '</footer>';
