...
/* ========================================
   ...
   ======================================== */
(function() {
    const SITE_SLUG = 'boominformativo';
    ...
    const SITE_SLOTS = {
        boominformativo: [
            { root: '.diagonal-section .diagonal-content', title: 'h2' },
            { root: '.asymmetric-grid .grid-item.item-large', title: 'h3', category: '.tag' },
            { root: '.asymmetric-grid .grid-item.item-tall', title: 'h3', category: '.tag' },
            { root: '.asymmetric-grid .grid-item:nth-of-type(3)', title: 'h3', category: '.tag' },
            { root: '.asymmetric-grid .grid-item:nth-of-type(4)', title: 'h3', category: '.tag' }
        ]
    };
    ...
    function applyArticleToSlot(slotRoot, slotDef, article) {
        ...
        if (!imgDiv && article.imageUrl && slotRoot.classList.contains('grid-item')) {
            slotRoot.style.backgroundImage = `linear-gradient(to bottom, transparent 30%, rgba(10,25,47,0.9)), url(${article.imageUrl})`;
            slotRoot.style.backgroundSize = 'cover';
            slotRoot.style.backgroundPosition = 'center';
        }
