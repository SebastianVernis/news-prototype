(function () {
    const HEADER_HTML = '<header class="site-header">' +
        '<div class="header-container">' +
            '<div class="logo-section">' +
                '<a href="/"><img src="https://placehold.co/400x100/8b0000/ffffff?text=BreakingCenter" alt="BreakingCenter"></a>' +
            '</div>' +
            '<nav class="main-nav">' +
                '<a href="/">Inicio</a>' +
    ...
    const FOOTER_HTML = '<footer class="site-footer">' +
        '<div class="footer-logo">' +
            '<img src="https://placehold.co/400x100/8b0000/ffffff?text=BreakingCenter" alt="BreakingCenter">' +
        '</div>' +
        ...
        '</div>' +
        '<p>&copy; ' + new Date().getFullYear() + ' BreakingCenter. Todos los derechos reservados.</p>' +
    '</footer>';
