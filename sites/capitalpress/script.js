...
(function() {
    ...
    const SITE_SLOTS = {
        capitalpress: [
            { root: '.minimal-grid .minimal-card:nth-of-type(1)', title: 'h2', excerpt: 'p', category: '.category-label', image: '.card-image', link: 'a.read-link' },
            { root: '.minimal-grid .minimal-card:nth-of-type(2)', title: 'h2', excerpt: 'p', category: '.category-label', image: '.card-image', link: 'a.read-link' }
        ]
    };
