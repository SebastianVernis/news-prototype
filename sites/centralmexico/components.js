/**
 * Central México - Componentes Compartidos
...
<div id="site-preloader" class="cm-preloader">
    <div class="cm-preloader-logo">
        <img src="${base}logo-header.png" alt="Central México">
    </div>
    <div class="cm-balls-container">
        <div class="cm-ball cm-ball-1"></div>
        <div class="cm-ball cm-ball-2"></div>
        <div class="cm-ball cm-ball-3"></div>
    </div>
</div>
<style>
.cm-preloader {
...
.cm-ball {
    ...
    height: 18px;
    border-radius: 50%;
    animation: cm-bounce 0.6s ease-in-out infinite alternate;
}
.cm-ball-1 { background: #9C2E3C; animation-delay: 0s; }
.cm-ball-2 { background: #5B666C; animation-delay: 0.2s; }
.cm-ball-3 { background: #9C2E3C; animation-delay: 0.4s; }
@keyframes cm-bounce {
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo-header.png" alt="Central México" class="site-logo" style="transform: scale(2); transform-origin: left center;">
            </a>
        </div>
        <nav class="main-nav">
...
<section class="breaking-news">
    ...
    <div class="breaking-ticker">
        <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
            <span class="ticker-item">Bienvenido a Central México &mdash; Información verificada las 24 horas</span>
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                <div class="footer-logo">
                    <img src="${base}logo-header.png" alt="Central México">
                    <h3>Central México</h3>
                </div>
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">Noticias del centro del país. Información veraz y oportuna.</p>
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; 2026 Central México. Todos los derechos reservados.</p>
    ...
    function initImageFallbacks() {
        ...
        function applyFallback(img) {
            ...
            img.addEventListener('error', function () {
                ...
                this.style.background = 'linear-gradient(160deg,#F4F5F6 0%,#E8EAEC 100%)';
        ...
        window.addEventListener('load', function () {
            setTimeout(function () {
                ...
                if (pre) {
                    ...
                    setTimeout(function () { if (pre.parentNode) pre.parentNode.removeChild(pre); }, 400);
                }
            }, 600);
        });
    }
