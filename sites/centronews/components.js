...
<div id="preloader" style="position:fixed;top:0;left:0;width:100%;height:100%;z-index:999999;display:flex;flex-direction:column;justify-content:center;align-items:center;background:linear-gradient(135deg,#1A1A1A 0%,#2D2D2D 40%,#1A1A1A 100%);">
    <div style="text-align:center;">
        <div style="margin-bottom:25px;animation:bu-spin3D 2s ease-in-out infinite;">
            <img src="https://placehold.co/400x100/0056b3/ffffff?text=CentroNews" alt="Bitácora Urbana" style="height:110px;width:auto;filter:brightness(0) invert(1);">
        </div>
    ...
    <div class="header-container">
        <div class="logo-section">
            <a href="/" style="display:block;line-height:0;">
                <img src="https://placehold.co/400x100/0056b3/ffffff?text=CentroNews" alt="CentroNews" class="site-logo">
            </a>
        </div>
        <nav class="main-nav">
...
<footer class="site-footer">
    <div class="footer-logo">
        <img src="https://placehold.co/400x100/0056b3/ffffff?text=CentroNews" alt="CentroNews">
    </div>
    ...
    function initBreakingTicker() {
        fetch('https://cms-nuevos2.sebastianvernis.workers.dev/api/ticker/headlines?limit=10')
            .then(function(r) { return r.json(); })
            .then(function(data) {
