...
(function() {
    ...
    const SITE_SLOTS = {
        diarioexpress: [
            { root: '.cards-section .card:nth-of-type(1)', title: 'h2', excerpt: 'p', category: '.card-meta', image: '.card-img' },
            { root: '.cards-section .card:nth-of-type(2)', title: 'h2', excerpt: 'p', category: '.card-meta', image: '.card-img' },
            { root: '.cards-section .card:nth-of-type(3)', title: 'h2', excerpt: 'p', category: '.card-meta', image: '.card-img' }
        ]
    };
