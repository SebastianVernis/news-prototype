...
/* ========================================
   ...
   ======================================== */
(function() {
    const SITE_SLUG = 'elpulsomexicano';
    ...
    const SITE_SLOTS = {
        elpulsomexicano: [
            { root: '.max-grid .max-card.card-1', title: 'h2', excerpt: 'p', image: '.max-img', link: '.read-btn' },
            { root: '.max-grid .max-card.card-2', title: 'h2', excerpt: 'p', image: '.max-img', link: '.read-btn' },
            { root: '.max-grid .max-card.card-3', title: 'h2', excerpt: 'p', image: '.max-img', link: '.read-btn' }
        ]
    };
