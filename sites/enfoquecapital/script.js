...
/* ========================================
   ...
   ======================================== */
(function() {
    const SITE_SLUG = 'enfoquecapital';
    ...
    const SITE_SLOTS = {
        enfoquecapital: [
            { root: '.right-pane .article-card:nth-of-type(1)', title: 'h2', excerpt: 'p', category: '.category-label', image: '.square-img', link: 'a.read-more' },
            { root: '.right-pane .article-card:nth-of-type(2)', title: 'h2', excerpt: 'p', category: '.category-label', image: '.square-img', link: 'a.read-more' },
            { root: '.right-pane .article-card:nth-of-type(3)', title: 'h2', excerpt: 'p', category: '.category-label', image: '.square-img', link: 'a.read-more' }
        ]
    };
