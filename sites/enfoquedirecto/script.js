...
/* ========================================
   ...
   ======================================== */
(function() {
    const SITE_SLUG = 'enfoquedirecto';
    ...
    const SITE_SLOTS = {
        enfoquedirecto: [
            { root: '.video-section .video-card:nth-of-type(1)', title: 'h3', image: '.video-thumb' },
            { root: '.video-section .video-card:nth-of-type(2)', title: 'h3', image: '.video-thumb' },
            { root: '.video-section .video-card:nth-of-type(3)', title: 'h3', image: '.video-thumb' },
            { root: '.editorial-grid .article-card:nth-of-type(1)', title: 'h2', excerpt: 'p', category: '.category-tag', image: '.article-img', link: 'a.read-more' },
            { root: '.editorial-grid .article-card:nth-of-type(2)', title: 'h2', excerpt: 'p', category: '.category-tag', image: '.article-img', link: 'a.read-more' }
        ]
    };
