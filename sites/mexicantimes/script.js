...
(function() {
    ...
    const SITE_SLOTS = {
        mexicantimes: [
            { root: '.timeline-container .timeline-item.right:nth-of-type(2)', title: '.timeline-content h2', excerpt: '.timeline-content p', category: '.category-name' },
            { root: '.timeline-container .timeline-item.left:nth-of-type(3)', title: '.timeline-content h2', excerpt: '.timeline-content p', category: '.category-name', image: '.timeline-img' },
            { root: '.timeline-container .timeline-item.right:nth-of-type(4)', title: '.timeline-content h2', excerpt: '.timeline-content p', category: '.category-name' }
        ]
    };
