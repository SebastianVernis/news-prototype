...
(function() {
    ...
    const SITE_SLOTS = {
        mexico360noticias: [
            { root: '.left-col .brief-card:nth-of-type(1)', title: 'h3', excerpt: 'p', category: '.category-tag' },
            { root: '.left-col .brief-card:nth-of-type(2)', title: 'h3', excerpt: 'p', category: '.category-tag' },
            { root: '.left-col .brief-card:nth-of-type(3)', title: 'h3', excerpt: 'p', category: '.category-tag' }
        ]
    };
