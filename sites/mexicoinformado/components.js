/**
 * México Informado - Componentes Compartidos
...
(function () {
    ...
    // ── PRELOADER: rotating-square ───────────────────────────────────────────
    const PRELOADER_HTML = `
<div id="site-preloader" class="mi-preloader">
    <img src="${base}logo-header.png" alt="México Informado" class="mi-preloader-logo">
    <div class="mi-rotating-square"></div>
    <p class="mi-preloader-text">México Informado</p>
</div>
<style>
.mi-preloader {
    position: fixed;
...
.mi-preloader.loaded { opacity: 0; pointer-events: none; }
.mi-preloader-logo {
    height: 70px;
    width: auto;
    object-fit: contain;
...
.mi-rotating-square {
    width: 52px;
    height: 52px;
    background: var(--mi-copper, #9D865F);
    animation: mi-rotateSquare 2s cubic-bezier(0.68,-0.55,0.265,1.55) infinite;
}
@keyframes mi-rotateSquare {
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo-header.png" alt="México Informado" class="site-logo" style="transform: scale(2); transform-origin: left center;">
            </a>
        </div>
        <nav class="main-nav">
...
<section class="breaking-news">
    ...
    <div class="breaking-ticker">
        <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
            <span class="ticker-item">Bienvenido a México Informado &mdash; Periodismo con perspectiva</span>
            <span class="ticker-item">&nbsp;&bull;&nbsp;</span>
            <span class="ticker-item">Noticias verificadas de México y el mundo</span>
        </marquee>
    </div>
</section>
<style>
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                <div class="footer-logo">
                    <img src="${base}logo-header.png" alt="México Informado">
                    <h3>México Informado</h3>
                </div>
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">Periodismo con perspectiva. Noticias de México y el mundo con análisis profundo.</p>
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; 2026 México Informado. Todos los derechos reservados.</p>
    ...
    function initImageFallbacks() {
        ...
        function applyFallback(img) {
            ...
            img.addEventListener('error', function () {
                ...
                this.style.background = 'linear-gradient(160deg,#0D1B2A 0%,#1B3A5C 100%)';
