...
(function() {
    ...
    const SITE_SLOTS = {
        mradio: [
            { root: '.neu-grid .grid-card:nth-of-type(1)', title: 'h2', excerpt: 'p', category: '.category-neu', image: '.card-img', link: '.btn-neu' },
            { root: '.neu-grid .grid-card:nth-of-type(2)', title: 'h2', excerpt: 'p', category: '.category-neu', image: '.card-img', link: '.btn-neu' },
            { root: '.neu-grid .grid-card:nth-of-type(3)', title: 'h2', excerpt: 'p', category: '.category-neu', image: '.card-img', link: '.btn-neu' }
        ]
    };
