/**
 * Nodo Informativo - Componentes Compartidos
...
(function () {
    ...
    // ── PRELOADER: contador (número grande %) ────────────────────────────────
    const PRELOADER_HTML = `
<div id="site-preloader" class="ni-preloader">
    <div class="ni-preloader-content">
        <div class="ni-preloader-number" id="ni-preloader-number">0</div>
        <div class="ni-preloader-percent">%</div>
    </div>
    <div class="ni-preloader-progress">
        <div class="ni-preloader-bar" id="ni-preloader-bar"></div>
    </div>
    <p class="ni-preloader-label">Nodo Informativo</p>
</div>
<style>
.ni-preloader {
    position: fixed;
    ...
    background: linear-gradient(160deg, #192D3C 0%, #215574 100%);
    display: flex;
...
.ni-preloader.loaded { opacity: 0; visibility: hidden; }
.ni-preloader-content {
    display: flex;
...
.ni-preloader-number {
    ...
    font-weight: 900;
    color: #FEFDFD;
    text-shadow: 0 4px 30px rgba(42,159,213,0.4);
    line-height: 1;
}
.ni-preloader-percent {
    font-family: 'Arial Black', 'Helvetica Neue', sans-serif;
    font-size: clamp(36px, 6vw, 72px);
    font-weight: 900;
    color: rgba(152,207,233,0.7);
    line-height: 1;
}
.ni-preloader-progress {
    position: absolute;
    bottom: 0; left: 0;
...
.ni-preloader-bar {
    height: 100%;
    width: 0%;
    background: linear-gradient(90deg, #2A9FD5, #98CFE9);
    transition: width 0.1s linear;
}
.ni-preloader-label {
    font-family: 'Arial', sans-serif;
    color: rgba(152,207,233,0.6);
    font-size: 0.75rem;
    letter-spacing: 4px;
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo-header.png" alt="Nodo Informativo" class="site-logo" style="transform: scale(2); transform-origin: left center;">
            </a>
        </div>
        <nav class="main-nav">
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                <div class="footer-logo">
                    <img src="${base}logo-header.png" alt="Nodo Informativo">
                    <h3>Nodo Informativo</h3>
                </div>
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">Información precisa y oportuna. El nodo central de las noticias de México.</p>
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; 2026 Nodo Informativo. Todos los derechos reservados.</p>
    ...
    function initImageFallbacks() {
        ...
        function applyFallback(img) {
            ...
            img.addEventListener('error', function () {
                ...
                this.style.background = 'linear-gradient(160deg,#192D3C 0%,#215574 100%)';
        ...
        // Watch for dynamically added images (articles loaded via JS)
    ...
    function initPreloader() {
        const numberEl  = document.getElementById('ni-preloader-number');
        const barEl     = document.getElementById('ni-preloader-bar');
        const preloader = document.getElementById('site-preloader');
        if (!numberEl || !barEl || !preloader) return;
    ...
    function init() {
        ...
        // Image fallbacks (logo when image fails to load)
        initImageFallbacks();
