/**
 * Noticias123 - Componentes Compartidos
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo3.png" alt="Noticias123" class="site-logo" style="transform-origin: left center;">
            </a>
        </div>
        <nav class="main-nav">
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; ${new Date().getFullYear()} Noticias123. Todos los derechos reservados.</p>
    ...
    function initImageFallbacks() {
        ...
        function applyFallback(img) {
            ...
            img.addEventListener('error', function () {
                ...
                this.style.background = 'linear-gradient(160deg,#d32f2f 0%,#b71c1c 100%)';
