...
/* ========================================
   ...
   ======================================== */
(function() {
    const SITE_SLUG = 'noticiashorizonte';
    ...
    const SITE_SLOTS = {
        noticiashorizonte: [
            { root: '.z-pattern-section .z-row.reverse', title: '.z-content h2', excerpt: '.z-content p', category: '.z-content .category', image: '.z-image', link: '.btn-outline' },
            { root: '.gallery-grid .gallery-card:nth-of-type(1)', title: 'h3', excerpt: 'p', category: '.category', image: '.gallery-img' },
            { root: '.gallery-grid .gallery-card:nth-of-type(2)', title: 'h3', excerpt: 'p', category: '.category', image: '.gallery-img' },
            { root: '.gallery-grid .gallery-card:nth-of-type(3)', title: 'h3', excerpt: 'p', category: '.category', image: '.gallery-img' }
        ]
    };
