(function () {
    const HEADER_HTML = '<header class="site-header">' +
        '<div class="header-container">' +
            '<div class="logo-section">' +
                '<a href="/"><img src="https://placehold.co/400x100/2e8b57/ffffff?text=Integra" alt="Integra"></a>' +
            '</div>' +
            '<nav class="main-nav">' +
                '<a href="/">Inicio</a>' +
    ...
    const FOOTER_HTML = '<footer class="site-footer">' +
        '<div class="footer-logo">' +
            '<img src="https://placehold.co/400x100/2e8b57/ffffff?text=Integra" alt="Integra">' +
        '</div>' +
        ...
        '</div>' +
        '<p>&copy; ' + new Date().getFullYear() + ' Integra. Todos los derechos reservados.</p>' +
    '</footer>';
