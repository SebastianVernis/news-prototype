...
(function() {
    ...
    const SITE_SLOTS = {
        pulsodiario: [
            { root: '.top-section .side-stack .side-article:nth-of-type(1)', title: 'h2', category: '.tag-pill' },
            { root: '.top-section .side-stack .side-article:nth-of-type(2)', title: 'h2', category: '.tag-pill' },
            { root: '.horizontal-scroll-container .scroll-card:nth-of-type(1)', title: '.scroll-content h2', image: '.scroll-img', link: '.read-btn' },
            { root: '.horizontal-scroll-container .scroll-card:nth-of-type(2)', title: '.scroll-content h2', image: '.scroll-img', link: '.read-btn' },
            { root: '.horizontal-scroll-container .scroll-card:nth-of-type(3)', title: '.scroll-content h2', image: '.scroll-img', link: '.read-btn' }
        ]
    };
