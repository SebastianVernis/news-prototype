...
(function() {
    ...
    const SITE_SLOTS = {
        puntoclave: [
            { root: '.top-section .side-news .side-item:nth-of-type(1)', title: 'h3', category: '.tag' },
            { root: '.top-section .side-news .side-item:nth-of-type(2)', title: 'h3', category: '.tag' },
            { root: '.top-section .side-news .side-item:nth-of-type(3)', title: 'h3', category: '.tag' },
            { root: '.grid-section .card:nth-of-type(1)', title: 'h2', excerpt: 'p', category: '.tag', image: '.card-img' },
            { root: '.grid-section .card:nth-of-type(2)', title: 'h2', excerpt: 'p', category: '.tag', image: '.card-img' },
            { root: '.grid-section .card:nth-of-type(3)', title: 'h2', excerpt: 'p', category: '.tag', image: '.card-img' }
        ]
    };
