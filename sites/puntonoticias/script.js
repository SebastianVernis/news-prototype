...
(function() {
    ...
    const SITE_SLOTS = {
        puntonoticias: [
            { root: '.card-grid .card:nth-of-type(1)', title: '.card-body h2', excerpt: '.card-body p', category: '.card-body .tag', image: '.card-img' },
            { root: '.card-grid .card:nth-of-type(2)', title: '.card-body h2', excerpt: '.card-body p', category: '.card-body .tag', image: '.card-img' },
            { root: '.card-grid .card:nth-of-type(3)', title: '.card-body h2', excerpt: '.card-body p', category: '.card-body .tag', image: '.card-img' },
            { root: '.card-grid .card:nth-of-type(4)', title: '.card-body h2', excerpt: '.card-body p', category: '.card-body .tag', image: '.card-img' },
            { root: '.card-grid .card:nth-of-type(5)', title: '.card-body h2', excerpt: '.card-body p', category: '.card-body .tag', image: '.card-img' },
            { root: '.card-grid .card:nth-of-type(6)', title: '.card-body h2', excerpt: '.card-body p', category: '.card-body .tag', image: '.card-img' }
        ]
    };
