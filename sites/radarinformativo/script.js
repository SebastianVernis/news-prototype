...
(function() {
    ...
    const SITE_SLOTS = {
        radarinformativo: [
            { root: '.tech-grid .tech-card:nth-of-type(1)', title: 'h3', excerpt: 'p', category: '.tag', image: '.tech-img' },
            { root: '.tech-grid .tech-card:nth-of-type(2)', title: 'h3', excerpt: 'p', category: '.tag', image: '.tech-img' },
            { root: '.tech-grid .tech-card:nth-of-type(3)', title: 'h3', excerpt: 'p', category: '.tag', image: '.tech-img' }
        ]
    };
