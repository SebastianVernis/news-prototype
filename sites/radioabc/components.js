/**
 * RadioABC - Componentes Compartidos
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo4.png" alt="RadioABC" class="site-logo" style="transform-origin: left center;">
            </a>
        </div>
        <nav class="main-nav">
    ...
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                ...
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">La voz de la información. Noticias con la tradición y confianza de la radio.</p>
    ...
    function initImageFallbacks() {
        ...
        function applyFallback(img) {
            ...
            img.addEventListener('error', function () {
                ...
                this.style.background = 'linear-gradient(160deg,#000080 0%,#0000cd 100%)';
