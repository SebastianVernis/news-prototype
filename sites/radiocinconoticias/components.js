/**
 * Radio Cinco Noticias - Componentes Compartidos
...
(function () {
    ...
    // ── PRELOADER: circle-expand ─────────────────────────────────────────────
    const PRELOADER_HTML = `
<div id="site-preloader" class="rc-preloader">
    <div class="rc-circle-expand"></div>
    <div class="rc-circle-expand rc-circle-2"></div>
    <img src="${base}logo-header.png" alt="Radio Cinco Noticias" class="rc-preloader-logo">
    <p class="rc-preloader-text">Radio Cinco Noticias</p>
</div>
<style>
.rc-preloader {
    position: fixed;
    ...
    background: linear-gradient(135deg, #1A0608 0%, #91131C 100%);
    display: flex;
...
.rc-preloader.loaded { opacity: 0; pointer-events: none; }
.rc-circle-expand {
    position: absolute;
    width: 60px;
    height: 60px;
    border: 3px solid rgba(189,122,126,0.6);
    border-radius: 50%;
    animation: rc-expand 1.8s ease-out infinite;
}
.rc-circle-2 {
    animation-delay: 0.9s;
    border-color: rgba(171,71,78,0.4);
}
@keyframes rc-expand {
...
<header class="header">
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo-header.png" alt="Radio Cinco Noticias" class="site-logo" style="transform-origin: left center;">
            </a>
        </div>
        <nav class="main-nav">
    ...
    const TICKER_HTML = `
<div class="radio-bar">
    <div class="container radio-bar-inner">
        <div class="radio-weather" id="ticker-weather">
            <span id="weather-icon">🌤</span>
            <span id="weather-city">CDMX</span>
            <span id="weather-temp">--°</span>
        </div>
        <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
            <span class="ticker-item">Bienvenido a Radio Cinco Noticias &mdash; Información en tiempo real</span>
            <span class="ticker-item">&nbsp;&bull;&nbsp;</span>
            <span class="ticker-item">Noticias verificadas las 24 horas del día</span>
        </marquee>
    </div>
</div>
<style>
.radio-weather{display:flex;align-items:center;gap:5px;padding:0 12px 0 8px;
...
.radio-weather #weather-icon{font-size:0.9rem;line-height:1;}
.radio-weather #weather-city{font-weight:700;color:#fff;letter-spacing:0.5px;}
.radio-weather #weather-temp{color:rgba(255,255,255,0.75);}
</style>`;
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                <div class="footer-logo">
                    <img src="${base}logo-header.png" alt="Radio Cinco Noticias">
                    <h3>Radio Cinco Noticias</h3>
                </div>
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">Información en tiempo real. Radio y noticias digitales desde el corazón de México.</p>
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; 2026 Radio Cinco Noticias. Todos los derechos reservados.</p>
    ...
    function initImageFallbacks() {
        ...
        function applyFallback(img) {
            ...
            img.addEventListener('error', function () {
                ...
                this.style.background = 'linear-gradient(160deg,#1A0A00 0%,#3D1A00 100%)';
    ...
    function initBreakingTicker() {
        var tickerUrl = 'https://cms-originaux.sebastianvernis.workers.dev/api/ticker/headlines?limit=10&_ts=' + Date.now();
