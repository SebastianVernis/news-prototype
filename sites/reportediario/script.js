...
(function() {
    ...
    const SITE_SLOTS = {
        reportediario: [
            { root: '.classic-grid .classic-card:nth-of-type(1)', title: 'h3', excerpt: 'p', category: '.category-tag', image: '.card-img', link: 'a.read-more' },
            { root: '.classic-grid .classic-card:nth-of-type(2)', title: 'h3', excerpt: 'p', category: '.category-tag', image: '.card-img', link: 'a.read-more' },
            { root: '.classic-grid .classic-card:nth-of-type(3)', title: 'h3', excerpt: 'p', category: '.category-tag', image: '.card-img', link: 'a.read-more' }
        ]
    };
