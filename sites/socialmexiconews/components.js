(function () {
    const HEADER_HTML = '<header class="site-header">' +
        '<div class="header-container">' +
            '<div class="logo-section">' +
                '<a href="/"><img src="https://placehold.co/400x100/8e24aa/ffffff?text=SocialMexico" alt="SocialMexico"></a>' +
            '</div>' +
            '<nav class="main-nav">' +
                '<a href="/">Inicio</a>' +
    ...
    const FOOTER_HTML = '<footer class="site-footer">' +
        '<div class="footer-logo">' +
            '<img src="https://placehold.co/400x100/8e24aa/ffffff?text=SocialMexico" alt="SocialMexico">' +
        '</div>' +
        ...
        '</div>' +
        '<p>&copy; ' + new Date().getFullYear() + ' SocialMexico. Todos los derechos reservados.</p>' +
    '</footer>';
