/**
 * SocialMexico News - Componentes Compartidos
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo7.png" alt="SocialMexico News" class="site-logo" style="transform-origin: left center;">
            </a>
        </div>
        <nav class="main-nav">
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                <div class="footer-logo">
                    <img src="${base}logo7.png" alt="SocialMexico News">
                    <h3>SocialMexico News</h3>
                </div>
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">Conectando México a través de las redes. Noticias sociales y tendencias.</p>
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; ${new Date().getFullYear()} SocialMexico News. Todos los derechos reservados.</p>
    ...
    function initImageFallbacks() {
        ...
        function applyFallback(img) {
            ...
            img.addEventListener('error', function () {
                ...
                this.style.background = 'linear-gradient(160deg,#8e24aa 0%,#c2185b 100%)';
