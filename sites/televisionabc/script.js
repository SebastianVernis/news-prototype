...
(function() {
    ...
    const SITE_SLOTS = {
        televisionabc: [
            { root: '.hero-fin .opinion-sidebar .opinion-card:nth-of-type(1)', title: 'h3', excerpt: 'p' },
            { root: '.hero-fin .opinion-sidebar .opinion-card:nth-of-type(2)', title: 'h3', excerpt: 'p' },
            { root: '.paywall-grid .paywall-card:nth-of-type(1)', title: 'h2', excerpt: 'p', category: '.section-label', image: '.mini-img', link: '.btn-subscribe' },
            { root: '.paywall-grid .paywall-card:nth-of-type(2)', title: 'h2', excerpt: 'p', category: '.section-label', image: '.mini-img', link: '.btn-subscribe' },
            { root: '.paywall-grid .paywall-card:nth-of-type(3)', title: 'h2', excerpt: 'p', category: '.section-label', image: '.mini-img', link: '.btn-subscribe' }
        ]
    };
