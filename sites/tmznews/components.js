/**
 * TMZNews - Componentes Compartidos
...
<style>
.finance-ticker{background:rgba(10,10,10,0.95);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);
...
letter-spacing:1.5px;text-transform:uppercase;color:rgba(57,255,20,0.5);white-space:nowrap;
flex-shrink:0;border-right:1px solid rgba(57,255,20,0.15);padding-right:12px;}
...
.finance-ticker-value strong{color:#39ff14;font-weight:700;}
...
#weather-temp{color:rgba(255,255,255,0.7);}
    ...
    function initWeatherWidget() {
        ...
        fetch('https://cms-nuevos2.sebastianvernis.workers.dev/api/weather')
    ...
    function initFinanceTicker() {
        ...
        fetch('https://cms-nuevos2.sebastianvernis.workers.dev/api/ticker/financials')
            .then(function(r) { return r.json(); })
            .then(function(data) {
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo1.png" alt="TMZNews" class="site-logo" style="transform-origin: left center;">
            </a>
        </div>
        <nav class="main-nav">
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                ...
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">Lo más viral y trending de México. Entretenimiento e información al instante.</p>
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; ${new Date().getFullYear()} TMZNews. Todos los derechos reservados.</p>
    ...
    function initFixedHeader() {
        ...
        s.textContent =
            ...
            'background:rgba(17,17,17,0.92);border:1px solid rgba(57,255,20,0.2);border-radius:8px;width:44px;height:44px;' +
            'cursor:pointer;flex-direction:column;align-items:center;justify-content:center;gap:5px;' +
            'box-shadow:0 2px 12px rgba(0,0,0,0.5);padding:0;}' +
            '#mobile-hamburger span{display:block;width:22px;height:2px;background:#39ff14;border-radius:2px;' +
            ...
            'border-bottom:1px solid rgba(57,255,20,0.1)!important;width:100%!important;}' +
            '}';
    ...
    function initImageFallbacks() {
        ...
        function applyFallback(img) {
            ...
            img.addEventListener('error', function () {
                ...
                this.style.background = 'linear-gradient(160deg,#111111 0%,#39ff14 100%)';
