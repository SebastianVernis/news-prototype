(function () {
    const HEADER_HTML = '<header class="site-header">' +
        '<div class="header-container">' +
            '<div class="logo-section">' +
                '<a href="/"><img src="https://placehold.co/400x100/39ff14/ffffff?text=TMZNews" alt="TMZNews"></a>' +
            '</div>' +
            '<nav class="main-nav">' +
                '<a href="/">Inicio</a>' +
    ...
    const FOOTER_HTML = '<footer class="site-footer">' +
        '<div class="footer-logo">' +
            '<img src="https://placehold.co/400x100/39ff14/ffffff?text=TMZNews" alt="TMZNews">' +
        '</div>' +
