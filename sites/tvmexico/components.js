/**
 * TV México - Componentes Compartidos
...
<div id="site-preloader" class="tvm-preloader">
    <div class="tvm-glitch-wrap">
        <img src="${base}logo-header.png" alt="TV México" class="tvm-logo-main">
        <img src="${base}logo-header.png" alt="" class="tvm-logo-glitch tvm-glitch-1" aria-hidden="true">
        <img src="${base}logo-header.png" alt="" class="tvm-logo-glitch tvm-glitch-2" aria-hidden="true">
    </div>
    <div class="tvm-scanlines"></div>
    <p class="tvm-preloader-text">TV México</p>
</div>
<style>
.tvm-preloader {
    position: fixed;
...
.tvm-preloader.loaded { opacity: 0; pointer-events: none; }
...
.tvm-logo-main {
    ...
    position: relative;
    z-index: 2;
    animation: tvm-glitch-main 3s ease-in-out infinite;
}
...
.tvm-glitch-1 {
    filter: brightness(0) saturate(100%) invert(20%) sepia(100%) saturate(500%) hue-rotate(300deg);
    animation: tvm-glitch-1 3s ease-in-out infinite;
    clip-path: polygon(0 20%, 100% 20%, 100% 40%, 0 40%);
}

.tvm-glitch-2 {
    filter: brightness(0) saturate(100%) invert(60%) sepia(100%) saturate(300%) hue-rotate(180deg);
    animation: tvm-glitch-2 3s ease-in-out infinite;
    clip-path: polygon(0 60%, 100% 60%, 100% 80%, 0 80%);
}

@keyframes tvm-glitch-main {
...
@keyframes tvm-glitch-1 {
    0%, 89%, 100% { opacity: 0; transform: translate(0); }
    90%           { opacity: 0.8; transform: translate(-5px, 0); }
    92%           { opacity: 0.6; transform: translate(5px, 0); }
    94%           { opacity: 0; }
}

@keyframes tvm-glitch-2 {
    0%, 91%, 100% { opacity: 0; transform: translate(0); }
    92%           { opacity: 0.7; transform: translate(4px, 0); }
    94%           { opacity: 0.5; transform: translate(-4px, 0); }
    96%           { opacity: 0; }
}
...
.tvm-preloader-text {
    ...
    color: rgba(140,122,133,0.7);
    font-size: 0.7rem;
    letter-spacing: 6px;
    text-transform: uppercase;
    font-weight: 700;
    animation: tvm-text-flicker 4s ease-in-out infinite;
}

@keyframes tvm-text-flicker {
    0%, 95%, 100% { opacity: 1; }
    96%           { opacity: 0.2; }
    97%           { opacity: 1; }
    98%           { opacity: 0.4; }
    ...
    <div class="container header-container">
        <div class="logo-section">
            <a href="${base}index.html" style="display:block;line-height:0;">
                <img src="${base}logo-header.png" alt="TV México" class="site-logo" style="transform: scale(2); transform-origin: left center;">
            </a>
        </div>
        <nav class="main-nav">
...
<footer class="footer" style="padding:24px 0 12px;">
    <div class="container">
        <div class="footer-grid cols-3" style="gap:16px;">
            <div class="footer-column">
                <div class="footer-logo">
                    <img src="${base}logo-header.png" alt="TV México">
                    <h3>TV México</h3>
                </div>
                <p class="footer-about" style="font-size:0.82rem;line-height:1.5;margin:8px 0 10px;">Noticias y entretenimiento. La televisión digital de México.</p>
        ...
        <div class="footer-bottom" style="padding-top:10px;margin-top:0;">
            <p>&copy; 2026 TV México. Todos los derechos reservados.</p>
    ...
    function initImageFallbacks() {
        ...
        function applyFallback(img) {
            ...
            img.addEventListener('error', function () {
                ...
                this.style.background = 'linear-gradient(160deg,#0A0A0A 0%,#1A1A1A 100%)';
